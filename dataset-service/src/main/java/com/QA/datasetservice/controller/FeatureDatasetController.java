...
import com.commons.util.model.dto.FeatureDatasetDTO;
...
import com.QA.datasetservice.service.FeatureDatasetServiceImpl;
...
@RestController
@RequestMapping("/api/FeatureDataset/v1")
public class FeatureDatasetController {

    @Autowired
    private FeatureDatasetServiceImpl service;

    @Autowired
    private ErrorRepository errorRepository;

    @PostMapping("/create")
    @ApiOperation(value = "create", response = FeatureDatasetDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> create(@RequestBody FeatureDatasetDTO dto) throws AppException {
    ...
    @ApiOperation(value = "createList", response = FeatureDatasetDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> createList(@RequestBody List<FeatureDatasetDTO> dtoList) throws AppException {
    ...
    @GetMapping("/get")
    @ApiOperation(value = "get", response = FeatureDatasetDTO.class)
    ...
    @ApiOperation(value = "getSingle", response = FeatureDatasetDTO.class)
    ...
    @PutMapping("/update")
    @ApiOperation(value = "update", response = FeatureDatasetDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> update(@RequestBody FeatureDatasetDTO dto) throws AppException {
    ...
    @PutMapping("/delete")
    @ApiOperation(value = "delete", response = FeatureDatasetDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> delete(@RequestBody FeatureDatasetDTO dto) throws AppException {
