...
import com.QA.datasetservice.service.PageDatasetServiceImpl;
...
@RestController
@RequestMapping("/api/PageDataset/v1")
public class PageDatasetController {

    @Autowired
    private PageDatasetServiceImpl service;

    @Autowired
    private ErrorRepository errorRepository;

    @PostMapping("/create")
    @ApiOperation(value = "create", response = PageStructureDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> create(@RequestBody PageStructureDTO dto) throws AppException {
    ...
    @ApiOperation(value = "createList", response = PageStructureDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> createList(@RequestBody List<PageStructureDTO> dtoList) throws AppException {
    ...
    @GetMapping("/get")
    @ApiOperation(value = "get", response = PageStructureDTO.class)
    ...
    @ApiOperation(value = "getSingle", response = PageStructureDTO.class)
    ...
    @PutMapping("/update")
    @ApiOperation(value = "update", response = PageStructureDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> update(@RequestBody PageStructureDTO dto) throws AppException {
    ...
    @PutMapping("/delete")
    @ApiOperation(value = "delete", response = PageStructureDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> delete(@RequestBody PageStructureDTO dto) throws AppException {
