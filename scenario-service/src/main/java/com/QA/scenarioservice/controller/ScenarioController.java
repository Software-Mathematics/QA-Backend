...
import com.QA.scenarioservice.service.ScenarioServiceImpl;
...
@RestController
@RequestMapping("/api/Scenario/v1")
public class ScenarioController {
    ...
    @PostMapping("/create")
    @ApiOperation(value = "create", response = ScenarioDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> create(@RequestBody ScenarioDTO dto) throws AppException {
    ...
    @ApiOperation(value = "createList", response = ScenarioDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> createList(@RequestBody List<ScenarioDTO> dtoList) throws AppException {
    ...
    @GetMapping("/get")
    @ApiOperation(value = "get", response = ScenarioDTO.class)
    ...
    @ApiOperation(value = "getSingle", response = ScenarioDTO.class)
    ...
    @PutMapping("/update")
    @ApiOperation(value = "update", response = ScenarioDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> update(@RequestBody ScenarioDTO dto) throws AppException {
    ...
    @PutMapping("/delete")
    @ApiOperation(value = "delete", response = ScenarioDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> delete(@RequestBody ScenarioDTO dto) throws AppException {
