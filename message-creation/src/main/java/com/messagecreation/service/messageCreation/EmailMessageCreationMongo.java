...
@Component
public class EmailMessageCreationMongo implements MessageCreationMongo {
    ...
    public MessageTableMongo createMessage(TemplateTableMongo templateTableMongo, Payload payload) throws IOException, TemplateException {
        ...
        if (templateTableMongo.getBodyTemplateFormat() != null && templateTableMongo.getBodyTemplateFormat().equalsIgnoreCase("ftl")){
        ...
        if (!payload.getMsgType().equalsIgnoreCase("SMS") && templateTableMongo.getSubTemplateFormat() != null && templateTableMongo.getSubTemplateFormat().equalsIgnoreCase("ftl")){
        ...
        messageTableMongo.setId(UUID.randomUUID().toString());
