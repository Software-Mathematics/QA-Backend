...
import com.role_service.service.RoleServiceImpl;
...
public class RoleController {
    ...
    @PostMapping("/create")
    @ApiOperation(value = "create", response = RoleDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> create(@RequestBody RoleDTO dto) throws AppException {
    ...
    @ApiOperation(value = "createList", response = RoleDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> createList(@RequestBody List<RoleDTO> dtoList) throws AppException {
    ...
    @GetMapping("/get")
    @ApiOperation(value = "get", response = RoleDTO.class)
    ...
    @ApiOperation(value = "getSingle", response = RoleDTO.class)
    ...
    @PutMapping("/update")
    @ApiOperation(value = "update", response = RoleDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> update(@RequestBody RoleDTO dto) throws AppException {
    ...
    @PutMapping("/delete")
    @ApiOperation(value = "delete", response = RoleDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> delete(@RequestBody RoleDTO dto) throws AppException {
