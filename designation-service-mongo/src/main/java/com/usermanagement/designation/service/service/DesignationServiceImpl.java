package com.usermanagement.designation.service.service;

import com.commons.data.dao.commonDao.BaseDaoImpl;
import com.commons.data.dao.daoImplementation.DesignationDao;
...
@Service
public class DesignationServiceImpl implements ServiceI {
    @Autowired
    ...
    public BaseDtoI create(BaseDtoI baseDtoI) throws AppException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        try {
            ...
            Designation entity = (Designation) baseAdapter.dtoToEntity(baseDtoI, new Designation());
            if (entity.getId() == null) {
                entity.setId(baseDao.generateSequence(Designation.SEQUENCE_NAME));
    ...
    public List<BaseDtoI> get(Map<String, Object> map) throws AppException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        try {
            return (List) baseAdapter.entityToDTO(baseDao.get(map, new Designation()), new DesignationDTO());
        }catch (Exception e){
            throw new AppException(e.getMessage());
        }
    }
    ...
    public org.apache.commons.lang3.tuple.Pair<List<BaseDtoI>, Page> getByPage(Map<String, Object> map, Pageable pageable) throws AppException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        try {
            ...
            map.remove("st");
            List<Designation> response = new ArrayList<>();
            ...
            return org.apache.commons.lang3.tuple.Pair.of((List<BaseDtoI>) baseAdapter.entityToDTO(response, new DesignationDTO()), page);
        }catch (Exception e){
            throw new AppException(e.getMessage());
        }
    }
