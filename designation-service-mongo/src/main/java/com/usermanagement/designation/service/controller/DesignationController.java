...
import com.usermanagement.designation.service.service.DesignationServiceImpl;
...
@RequestMapping("/api/designation/v2")
public class DesignationController {
    ...
    @PostMapping("/create")
    @ApiOperation(value = "create", response = DesignationDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> create(@RequestBody DesignationDTO dto) throws AppException {
    ...
    @ApiOperation(value = "createList", response = DesignationDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> createList(@RequestBody List<DesignationDTO> dtoList) throws AppException {
    ...
    @GetMapping("/get")
    @ApiOperation(value = "get", response = DesignationDTO.class)
    ...
    @ApiOperation(value = "getSingle", response = DesignationDTO.class)
    ...
    @PutMapping("/update")
    @ApiOperation(value = "update", response = DesignationDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> update(@RequestBody DesignationDTO dto) throws AppException {
    ...
    @PutMapping("/delete")
    @ApiOperation(value = "delete", response = DesignationDTO.class)
    public ResponseEntity<AppResponseDTO<BaseResponse>> delete(@RequestBody DesignationDTO dto) throws AppException {
